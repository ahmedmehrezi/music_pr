...
<div className="flex-1 flex flex-row justify-between items-center ">
  <img width={"50px"} className="g" src={song?.images?.coverart} />
  ...
  return(
    <div ref={divRef} className="xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 xl:max-w[500px] max-w-full flex flex-col">
      <div className="w-full flex flex-col">
        ...
        <div className="mt-4 felex flex-col gap-1">
          {TopPlay?.map((song, i) => (
            <TopChartCard 
            key={song.key}
            song={song}
      ...
      <div className="w-full  flec-row mt-8">
          <div className="flex flex-row justify-between items-center">
          ...
          >
            {TopPlay?.map((song, i) => (
              ...
              className="shadow-lg ss rounded-full animate-slideright">
